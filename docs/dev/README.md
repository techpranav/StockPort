...
Located in `docs/dev/` directory, served with `mkdocs.yml`:
...
Located in `docs/` directory, served with `mkdocs-user.yml`:
...
1. Edit markdown files in `docs/dev/` (developer) or `docs/` (user) directories
